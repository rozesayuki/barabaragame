//
//  GameViewCellViewController.swift
//  barabaragame
//
...
class GameViewCellViewController: UIViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        positionX = [width/2,width/2,width/2] //画像の位置を画像幅の中止にする
        self.start() //startというメゾットを呼び出す
